...
janeiro = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 1]
janeiro = janeiro.sort_values("ANO")

fevereiro = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 2]
fevereiro = fevereiro.sort_values("ANO")

março = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 3]
março = março.sort_values("ANO")

abril = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 4]
abril = abril.sort_values("ANO")

maio = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 5]
maio = maio.sort_values("ANO")

junho = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 6]
junho = junho.sort_values("ANO")

julho = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 7]
julho = julho.sort_values("ANO")

agosto = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 8]
agosto = agosto.sort_values("ANO")

setembro = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 9]
setembro = setembro.sort_values("ANO")

outubro = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 10]
outubro = outubro.sort_values("ANO")

novembro = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 11]
novembro = novembro.sort_values("ANO")

dezembro = regiao_cone_sul.loc[regiao_cone_sul["MES"] == 12]
...
plt.title("Precipitação total por mês da região Cone Sul de 2010 a 2019")
plt.show()
