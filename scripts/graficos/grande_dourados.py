...
janeiro = grande_dourados.loc[grande_dourados["MES"] == 1]
janeiro = janeiro.sort_values("ANO")

fevereiro = grande_dourados.loc[grande_dourados["MES"] == 2]
fevereiro = fevereiro.sort_values("ANO")

março = grande_dourados.loc[grande_dourados["MES"] == 3]
março = março.sort_values("ANO")

abril = grande_dourados.loc[grande_dourados["MES"] == 4]
abril = abril.sort_values("ANO")

maio = grande_dourados.loc[grande_dourados["MES"] == 5]
maio = maio.sort_values("ANO")

junho = grande_dourados.loc[grande_dourados["MES"] == 6]
junho = junho.sort_values("ANO")

julho = grande_dourados.loc[grande_dourados["MES"] == 7]
julho = julho.sort_values("ANO")

agosto = grande_dourados.loc[grande_dourados["MES"] == 8]
agosto = agosto.sort_values("ANO")

setembro = grande_dourados.loc[grande_dourados["MES"] == 9]
setembro = setembro.sort_values("ANO")

outubro = grande_dourados.loc[grande_dourados["MES"] == 10]
outubro = outubro.sort_values("ANO")

novembro = grande_dourados.loc[grande_dourados["MES"] == 11]
novembro = novembro.sort_values("ANO")

dezembro = grande_dourados.loc[grande_dourados["MES"] == 12]
...
plt.title(
    "Precipitação total por mês da região de Grande Dourados de 2010 a 2019"
)
plt.show()
