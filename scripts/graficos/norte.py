...
janeiro = norte.loc[norte["MES"] == 1]
janeiro = janeiro.sort_values("ANO")

fevereiro = norte.loc[norte["MES"] == 2]
fevereiro = fevereiro.sort_values("ANO")

março = norte.loc[norte["MES"] == 3]
março = março.sort_values("ANO")

abril = norte.loc[norte["MES"] == 4]
abril = abril.sort_values("ANO")

maio = norte.loc[norte["MES"] == 5]
maio = maio.sort_values("ANO")

junho = norte.loc[norte["MES"] == 6]
junho = junho.sort_values("ANO")

julho = norte.loc[norte["MES"] == 7]
julho = julho.sort_values("ANO")

agosto = norte.loc[norte["MES"] == 8]
agosto = agosto.sort_values("ANO")

setembro = norte.loc[norte["MES"] == 9]
setembro = setembro.sort_values("ANO")

outubro = norte.loc[norte["MES"] == 10]
outubro = outubro.sort_values("ANO")

novembro = norte.loc[norte["MES"] == 11]
novembro = novembro.sort_values("ANO")

dezembro = norte.loc[norte["MES"] == 12]
...
plt.title("Precipitação total por mês da região do Norte de 2010 a 2019")
plt.show()
