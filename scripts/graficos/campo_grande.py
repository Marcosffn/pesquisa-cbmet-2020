...
janeiro = campo_grande.loc[campo_grande["MES"] == 1]
janeiro = janeiro.sort_values("ANO")

fevereiro = campo_grande.loc[campo_grande["MES"] == 2]
fevereiro = fevereiro.sort_values("ANO")

março = campo_grande.loc[campo_grande["MES"] == 3]
março = março.sort_values("ANO")

abril = campo_grande.loc[campo_grande["MES"] == 4]
abril = abril.sort_values("ANO")

maio = campo_grande.loc[campo_grande["MES"] == 5]
maio = maio.sort_values("ANO")

junho = campo_grande.loc[campo_grande["MES"] == 6]
junho = junho.sort_values("ANO")

julho = campo_grande.loc[campo_grande["MES"] == 7]
julho = julho.sort_values("ANO")

agosto = campo_grande.loc[campo_grande["MES"] == 8]
agosto = agosto.sort_values("ANO")

setembro = campo_grande.loc[campo_grande["MES"] == 9]
setembro = setembro.sort_values("ANO")

outubro = campo_grande.loc[campo_grande["MES"] == 10]
outubro = outubro.sort_values("ANO")

novembro = campo_grande.loc[campo_grande["MES"] == 11]
novembro = novembro.sort_values("ANO")

dezembro = campo_grande.loc[campo_grande["MES"] == 12]
...
plt.title("Precipitação total por mês da região de Campo Grande de 2010 a 2019")
plt.show()
